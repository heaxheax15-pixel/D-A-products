...
function default_products_seed(): array
{
    return [
        ...
        ['id' => 3, 'name' => 'عسل أكاسيا', 'slug' => 'acacia', 'description' => 'عسل أكاسيا خفيف القوام، يذوب بسرعة ولا يتبلور بسهولة. الخيار الأمثل لمحبي الشاي والمخبوزات.', 'price' => 95.00, 'image' => 'images/product-acacia.webp', 'category' => 'flowers', 'is_bestseller' => 0, 'is_featured' => 0, 'rating' => 4],
